...
<template>
  <div class="detailBox tcommonBox">
    ...
    <header>
      ...
      <h2>
        {{detailObj.nickName}}<i class="fa fa-fw fa-user"></i>发表于 <span>{{ detailObj.createTime }}</span> •
    ...
    <div style="margin-top: 20px">
      <el-tag type="success" v-for="tag in detailObj.tagName" :key="tag" style="margin-left: 10px">{{tag}}</el-tag>
    </div>
      ...
      <el-row :class="pdonate?'donate-body':'donate-body donate-body-show'" :gutter="30">
        <el-col :span="12" class="donate-item">
          <div class="donate-tip">
            <img :src="detailObj.wechat_image?detailObj.wechat_image: 'static/img/wx_pay.jpg'"
...
export default {
  ...
  methods: { //事件处理器
    ...
    routeChange: function () {
      var that = this;
      that.aid = that.$route.query.aid === undefined ? '' : that.$route.query.aid;//获取传参的aid
      //判断用户是否存在
