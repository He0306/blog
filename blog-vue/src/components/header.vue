...
<template>
  <div class="">
        ...
        <el-col :span="24">
          ...
          <div class="headBox">
            <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect"
              ...
              <el-menu-item index="/Friendslink"><i class="fa fa-chain"></i>友链</el-menu-item>
              <div style="width: 200px;margin-left: 480px;margin-top: 5px">
                <el-input v-model="inputContent" placeholder="请输入内容" />
              </div>
              <div style="margin-left: 690px;margin-top: -29px">
                <el-button size="small"><i class="fa fa-search" @click="search()">搜索</i></el-button>
              </div>
              <div class="userInfo">
                ...
                <div v-show="haslogin" class="haslogin">
                  <img :src="userInfo.avatar" alt=""
                       style="width: 25px;border-radius: 50%;position: relative;top: 8px;right: 5px">
    ...
    <div class="headImgBox"
         :style="{backgroundImage:this.$store.state.themeObj.top_image?'url('+this.$store.state.themeObj.top_image+')':'url(static/img/headbg.jpg)'}">
      <div class="scene">
        <div><span id="luke"></span></div>
      </div>
      <div class="h-information">

        <img :src="this.$store.state.themeObj.head_portrait?this.$store.state.themeObj.head_portrait:'static/img/1.jpg'"
             alt="">

        <h2 class="h-description">

          {{ this.$store.state.themeObj.autograph ? this.$store.state.themeObj.autograph : "江山代有才人出，各领风骚数百年" }}
...
export default {
  data() { //选项 / 数据
    return {
      ...
      // path:'',//当前打开页面的路径
      input: '', //input输入内容
      headBg: 'url(static/img/headbg.jpg)', //头部背景图
      headTou: '', //头像
      projectList: '', //项目列表
    }
  },
  methods: { //事件处理器
    ...
    //搜索inputContent
    search() {
      this.$router.push({path: '/Search?search=' + this.inputContent})
    },
    getCategoryList() {
