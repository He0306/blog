          ...
          <li class="tmsg-c-item" v-for="(item,index) in commentList" :key="'common'+index">
            <article class="">
              ...
              <section>
                ...
                <div v-if="haslogin" class="tmsg-replay" @click="respondMsg(item.id,item.id,item.userId)">
                  回复
                </div>
              </section>
            </article>
              ...
              <li class="tmsg-c-item" v-for="(citem,cindex) in item.children" :key="'citem'+cindex">
                <article class="">
                  ...
                  <section>
                    ...
                    <div v-show="haslogin" class="tmsg-replay" @click="respondMsg(item.id,citem.id,citem.userId)">
                      回复
                    </div>
                  </section>
                </article>
